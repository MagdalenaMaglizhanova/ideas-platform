...
export default function PrologGuide() {
  ...
  const InteractiveQuestion = ({ question, answer }: { question: string; answer: string }) => {
    ...
    return (
      <div className={`mt-4 p-4 rounded-lg border ${currentTheme.card}`}>
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg border transition-all ${
                selected === option
                  ...
                  : `hover:bg-gray-100 dark:hover:bg-gray-700 ${currentTheme.card}`
              }`}
            >
              {option}
            </button>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <AnimatePresence mode="wait">
          {activeTab === 'basics' && (
            ...
            >
              <div className={`text-center p-8 rounded-2xl border ${currentTheme.card} mb-8`}>
                <h2 className="text-3xl font-bold mb-4">Introduction to Logic Programming</h2>
                <p className={`text-lg ${currentTheme.subtitle}`}>
              ...
              <div className="space-y-6">
                ...
                <div className={`rounded-2xl border overflow-hidden ${currentTheme.card}`}>
                ...
                <div className={`text-center p-6 rounded-2xl border ${currentTheme.card}`}>
  ...
  >
    ...
    <div className={`rounded-2xl border overflow-hidden ${currentTheme.card}`}>
      ...
      <div className="p-6 space-y-6">
          ...
          <table className="w-full border-collapse text-sm">
            <thead>
              <tr className={theme === 'dark' ? 'bg-gray-700' : 'bg-gray-100'}>
                <th className="border p-2 text-left">Likes</th>
                <th className="border p-2 text-center">Abby</th>
                <th className="border p-2 text-center">Bess</th>
                <th className="border p-2 text-center">Cody</th>
                <th className="border p-2 text-center">Dana</th>
              </tr>
            </thead>
            <tbody>
              {[
                ...
                <tr key={row.name} className={theme === 'dark' ? 'border-gray-700' : 'border-gray-200'}>
                  ...
                  {row.data.map((cell, idx) => (
                    <td key={idx} className="border p-2 text-center text-lg">{cell}</td>
                  ))}
                </tr>
              ))}
            </tbody>
        ...
        <div>
          <p className={`font-medium mb-3 ${currentTheme.subtitle}`}>Facts represented in logic:</p>
          <div className={`p-3 rounded-lg font-mono text-sm ${currentTheme.code}`}>
            {[
              "likes(abby, bess).",
              "likes(abby, cody).",
              "likes(bess, dana).",
  ...
  >
    {/* Header */}
    <div className={`text-center p-8 rounded-2xl border ${currentTheme.card}`}>
      <h2 className="text-3xl font-bold mb-4">Advanced Prolog Tutorials</h2>
      <p className={`text-lg ${currentTheme.subtitle}`}>
